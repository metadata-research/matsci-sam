...
1. Under **Suggest an alternative**, select **Start an alternative** and
   explain what should change.
2. Select **Draft alternative with a language model** and inspect the preview.
3. Select **Use this draft**, edit the wording, then **Review alternative**.
4. Select **Publish alternative** to create a separate definition credited to
...
Expand **History** to read revisions and comments in date order when more than
one event is recorded. Entries identify author edits, model contributions,
and restorations. Open the term, select **Advanced**, then **Provenance** to
inspect its broader [contribution history](/docs/provenance).
