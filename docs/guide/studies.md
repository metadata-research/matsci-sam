...
scope](/docs/communities) describes. Each study listed there has a study-step
control.

**Generate study steps** builds the instruction step, a position and review
step for each term, and the two closing questions when selected. **Regenerate
study steps** replaces those steps until a participant begins. The progress
